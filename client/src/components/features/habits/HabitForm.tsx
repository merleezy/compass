...
export default function HabitForm({ onCreate, onClose }: HabitFormProps) {
  ...
  function handleKeyDown(e: React.KeyboardEvent) {
    // e.target is typed as the loose EventTarget, so assert the element type
    // before reading a DOM-element-only property like tagName
