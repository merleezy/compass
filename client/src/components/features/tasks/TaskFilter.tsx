...
import type { DueStatus, TaskFilters } from '../../../types'

// Typing the array as { value: DueStatus } (instead of letting TS infer plain
// string) keeps toggleStatus's argument a real DueStatus.
...
export default function TaskFilter({ allTags, filters, onChange, onClear }: TaskFilterProps) {
  ...
  const toggleStatus = (status: DueStatus) => {
