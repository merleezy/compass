...
// Record<Urgency, string> = an object that MUST have one string entry for
// every member of the Urgency union — add a new urgency and the compiler
// demands a color for it here.
...
export default function TaskItem({ task, urgency, onToggle, onDelete, onEdit, existingTags = [] }: TaskItemProps) {
  ...
  const border = borderColor[urgency]
